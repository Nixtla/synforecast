...
Using 5 series for demonstration: ['H333', 'H75', 'H183', 'H252', 'H29']
...
``` text
Detailed comparison for series: H333

Statistic           Original Synthetic (avg)     Diff %   Source  
------------------------------------------------------------------
mean                549.4613        549.4636       0.0%   pinned  
std                 450.4994        450.5070       0.0%   pinned  
min                  16.0000       -421.3235    2733.3%   free    
max                2000.0000       1446.3660      27.7%   free    
range              1984.0000       1867.6895       5.9%   free    
cv                    0.8199          0.8199       0.0%   pinned  
skewness              0.9816         -0.0389     104.0%   free    
autocorr_lag1         0.8423          0.9818      16.6%   pinned  

Correlation of each synthetic draw to the source series: -0.03, 0.01, 0.00
...
``` text
  0%|          | 0.00/32.5M [00:00<?, ?iB/s] 21%|██        | 6.90M/32.5M [00:00<00:00, 68.9MiB/s] 42%|████▏     | 13.8M/32.5M [00:00<00:00, 67.9MiB/s] 63%|██████▎   | 20.6M/32.5M [00:00<00:00, 66.7MiB/s] 84%|████████▍ | 27.4M/32.5M [00:00<00:00, 67.3MiB/s]34.2MiB [00:00, 67.4MiB/s]                           40.9MiB [00:00, 66.5MiB/s]47.6MiB [00:00, 66.6MiB/s]54.2MiB [00:00, 66.0MiB/s]60.8MiB [00:00, 65.2MiB/s]67.3MiB [00:01, 64.2MiB/s]73.8MiB [00:01, 64.4MiB/s]80.3MiB [00:01, 64.4MiB/s]86.7MiB [00:01, 63.3MiB/s]93.3MiB [00:01, 64.1MiB/s]95.8MiB [00:01, 65.4MiB/s]
INFO:datasetsforecast.utils:Successfully downloaded Daily-train.csv, 95765153, bytes.
  0%|          | 0.00/198k [00:00<?, ?iB/s]576kiB [00:00, 40.8MiB/s]                  
INFO:datasetsforecast.utils:Successfully downloaded Daily-test.csv, 576459, bytes.
WARNING:synforecast.dataset:Generator GARCHGenerator failed for D3878: 1 validation error for GARCHGenerator
mean
  Extra inputs are not permitted [type=extra_forbidden, input_value=-2.0845481049562684, input_type=float]
    For further information visit https://errors.pydantic.dev/2.13/v/extra_forbidden. Falling back to AR(1) generation.
WARNING:synforecast.dataset:Generator GARCHGenerator failed for D3878: 1 validation error for GARCHGenerator
mean
  Extra inputs are not permitted [type=extra_forbidden, input_value=-2.0845481049562684, input_type=float]
    For further information visit https://errors.pydantic.dev/2.13/v/extra_forbidden. Falling back to AR(1) generation.
...
Using 4 series: ['D297', 'D3914', 'D782', 'D3878']

Analysis results:
  D297: SARIMAGenerator
  D3914: RandomWalkGenerator
  D782: SARIMAGenerator
  D3878: GARCHGenerator
...
Original series (5 series):
  Mean of means: 3850.4060 (std: 5360.9014)
  Mean of stds:  957.7394 (std: 1267.9505)
  Mean autocorr: 0.9442 (std: 0.0511)

Synthetic series (15 series):
  Mean of means: 3850.4258 (std: 5360.9356)
  Mean of stds:  957.7384 (std: 1267.9533)
  Mean autocorr: 0.9861 (std: 0.0097)
```
