...
> **The model**
>
> The generator produces sessionized activity with conversion behavior
> layered on daily and weekly traffic rhythms. Tune the session and
> conversion parameters to match different traffic profiles.
...
> **Related generators**
>
> -   [Daily active users](daily_active_users) — the aggregate
>     engagement metric.
> -   [Poisson process](../stochastic/poisson_process) — a baseline
>     arrival model.
>
