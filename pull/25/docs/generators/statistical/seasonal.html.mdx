...
> **Related generators**
>
> -   [SARIMA](sarima) — seasonality with autoregressive/moving-average
>     dynamics instead of a fixed wave.
> -   [ETS](ets) — seasonality through exponential-smoothing state-space
>     models.
> -   Layer on [anomalies](../../capabilities/anomalies) or
>     [changepoints](../../capabilities/changepoints) to stress-test a
>     seasonal model.
