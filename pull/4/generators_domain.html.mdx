...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of values (mostly zeros with intermittent demand)
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of sensor readings (NaN during failures).
...
Type | Description
---- | -----------
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | DataFrame in long format with columns \[id_col, time_col,
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | target_col\].
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of energy load values.
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Observed values (first observation dimension).
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of DAU values.
...
---- | -----------
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | DataFrame in long format with columns \[id_col, time_col,
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | target_col, event_col\], where event_col is 1 at steps where an
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | event occurred.
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of vital sign values.
...
Type | Description
---- | -----------
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | DataFrame with columns [id_col, time_col] plus one column per
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | vital sign, aligned on the same timestamps per patient.
...
---- | ---- | -----------
`dict` | <code>[dict](#dict)</code> | Model parameters and patient characteristics.
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of metric values.
...
Name | Type | Description
---- | ---- | -----------
`dict` | <code>[dict](#dict)\[[str](#str), [ndarray](#numpy.ndarray)\]</code> | All metrics as flat arrays, keyed by metric name plus
| <code>[dict](#dict)\[[str](#str), [ndarray](#numpy.ndarray)\]</code> | 'series_id'.
...
Name | Type | Description
---- | ---- | -----------
`dict` | <code>[dict](#dict)\[[str](#str), [int](#int)\]</code> | Stage name -> session count at that stage.
...
Name | Type | Description
---- | ---- | -----------
`dict` | <code>[dict](#dict)</code> | Model parameters and traffic characteristics.
