...
> clean copy of the same series. On real data you have neither; here
> both come for free.
...
precision at the cost of recall. Substitute your own detector to see
...
> denominator, so error appears to *drop* as you add noise — a real
...
>     accuracy picture, and where synthetic data pays off beyond it.
