...
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | (default ['unique_id', 'ds', 'y']), plus any exogenous or flag
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | columns.
