...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of time series values
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of time series values (counts per time period)
...
autocovariance `gamma(k) = (sigma^2/2) * (|k+1|^{2H} - 2|k|^{2H} + |k-1|^{2H})`, and the path satisfies `Var(B_H(t)) = sigma^2 * t^{2H}`.
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: fBm path values (or fGn increments if return_increments=True).
...
---- | ---- | -----------
`float` | <code>[float](#float)</code> | Estimated Hurst exponent, clipped to [0.01, 0.99].
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of values (counts, intensity, or event indicator)
...
Name | Type | Description
---- | ---- | -----------
`tuple` | <code>[tuple](#tuple)\[[ndarray](#numpy.ndarray), [ndarray](#numpy.ndarray)\]</code> | (event_times, intensity_at_events)
...
Name | Type | Description
---- | ---- | -----------
`dict` | <code>[dict](#dict)</code> | Model parameters and characteristics
...
Name | Type | Description
---- | ---- | -----------
`dict` | <code>[dict](#dict)</code> | Estimated parameters
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of values (price, returns, or volatility)
...
Name | Type | Description
---- | ---- | -----------
`tuple` | <code>[tuple](#tuple)\[[ndarray](#numpy.ndarray), [ndarray](#numpy.ndarray), [ndarray](#numpy.ndarray)\]</code> | (prices, volatilities, series_ids) arrays
...
Name | Type | Description
---- | ---- | -----------
`tuple` | <code>[tuple](#tuple)\[[ndarray](#numpy.ndarray), [ndarray](#numpy.ndarray), [ndarray](#numpy.ndarray)\]</code> | (values, regimes, series_ids) arrays
...
- lorenz: Lorenz attractor `x' = sigma(y-x), y' = x(rho-z) - y, z' = xy - beta*z`, integrated with RK4 and sampled every
...
- beta_ar: Beta AR(1) via conditional mean parameterization.
  mu_t = omega + phi * x\_{t-1}, x_t ~ Beta(mu_t * kappa,
  (1 - mu_t) * kappa), so E[x_t | x\_{t-1}] = mu_t and the stationary
  mean is omega / (1 - phi).
- logit_normal: AR(1) on the logit scale, sigmoid-transformed back:
  z_t = phi * z\_{t-1} + sigma * eps_t, x_t = sigmoid(z_t).
...
Type | Description
---- | -----------
<code>[ndarray](#numpy.ndarray)</code> | np.ndarray: Array of time series values in [lower, upper]
