...
Type | Description
---- | -----------
<code>[IntoDataFrame](#narwhals.stable.v2.typing.IntoDataFrame)</code> | DataFrame in long format with columns \[`unique_id`, `ds`, `y`\],
<code>[IntoDataFrame](#narwhals.stable.v2.typing.IntoDataFrame)</code> | plus `generator` when `with_generator_col` is True.
...
Type | Description
---- | -----------
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | DataFrame in long format with the wrapped generator's
<code>[IntoDataFrameT](#narwhals.stable.v2.typing.IntoDataFrameT)</code> | [id_col, time_col, target_col] columns and dataframe engine.
