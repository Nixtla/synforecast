...
> [`balanced_pool`](balanced_pool) is a ready-made list of 42 generators
> you can drop into a `SynSet`, and
> [`generate_series`](../getting-started/quickstart) wraps that pool in
> a one-liner. Reach for `SynSet` when you want an explicit, curated mix
> of generators.
