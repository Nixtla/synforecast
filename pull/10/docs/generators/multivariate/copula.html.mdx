---
title: Copula Generator
---

Generate multivariate time series with specified dependency structures
using copulas. Copulas allow you to model the dependency between
variables independently of their marginal distributions.
