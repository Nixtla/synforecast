---
title: Stochastic Volatility Generator
---

Generate price paths with stochastic volatility models including Heston
and SABR. These models capture the empirical observation that volatility
itself is random and often negatively correlated with price movements
(the leverage effect).
