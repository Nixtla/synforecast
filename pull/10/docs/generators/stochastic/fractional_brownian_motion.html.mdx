---
title: Fractional Brownian Motion Generator
---

Generate fractional Brownian motion (fBm) time series with different
Hurst exponents. The Hurst exponent controls the memory of the process:
H \< 0.5 is anti-persistent (mean-reverting), H = 0.5 is standard
Brownian motion, and H \> 0.5 is persistent (trending).
