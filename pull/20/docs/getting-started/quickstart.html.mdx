...
> **When do you reach for synthetic data?**
>
...
plot_panel(panel, "A balanced synthetic panel from generate_series")
```

![](./quickstart_files/figure-markdown_strict/cell-3-output-1.png)

Each line is a *different* data-generating process — a random walk here,
a seasonal profile there, a volatile stretch elsewhere. That diversity
is what turns the panel into a stress test for a forecaster rather than
one shape repeated six times.
...
-   **Generators** — 31 generators from SARIMA, ETS, and GARCH to
