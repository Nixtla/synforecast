...
Type | Description
---- | -----------
<code>[dict](#dict)\[[str](#str), [dict](#dict)\]</code> | Mapping of each `unique_id` to its analysis results. Every entry
<code>[dict](#dict)\[[str](#str), [dict](#dict)\]</code> | holds `recommended_generator` (the chosen generator name),
<code>[dict](#dict)\[[str](#str), [dict](#dict)\]</code> | `properties` (all detected statistical properties), and
<code>[dict](#dict)\[[str](#str), [dict](#dict)\]</code> | `fitted_params` (the estimated generator parameters).
...
<code>[IntoFrameT](#narwhals.stable.v2.typing.IntoFrameT)</code> | Synthetic series IDs follow the pattern `"{original_id}_aug_{i}"`
